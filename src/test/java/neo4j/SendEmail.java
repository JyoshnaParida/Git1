...
////        email.setAuthenticator(new DefaultAuthenticator("mudili.sivakumar@gaiansolutions.com", "Gaian@123"
////        		+ ""));
...
//        email.setSubject("Auto Generated Mail : Neo4j Api Automation test report");
//        email.setMsg("Dear Team,\n\n"
//        		+ "please find the Neo4j Api Automation test report\n\n"
//        		+ "Thanks & Regards\n"
//        		+ "QA Automation Team.\n\n"
//        		+ "Note: For browser compatibility problems, please download and open the report");
//       email.addCc("qateam@gaiansolutions.com ");
//       
